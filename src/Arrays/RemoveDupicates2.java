 ...
 * 
 * 
 * INTUITION : This code works for any k value. just need to change what j < k || nums[i] > nums[j - k]
 *             We are checking for every j that we need to update, the value is greater than -2 of j position.
 *              if we dont get that we increment and search for it.
 */
