 ...
 * 
 * Group Guests
Imagine you're organizing a grand party with three different rooms for your guests. Each guest belongs to a specific group (1, 2, or 3). 
But things get messy! Some guests end up in the wrong rooms, and the rooms themselves are quite unorganized.
...
Minimum adjustments: You can "swap" a guest's group assignment (change their "ticket") any number of times. 
But the goal is to use the fewest number of swaps possible to achieve the desired seating arrangement.
Input:
